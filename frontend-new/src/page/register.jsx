...
const Register = () => {
    ...
    async function handlesubmit(e) {
        ...
        try {
            ...
            if (data.success) {
                navigate("/login");                            // fixed: was '/api/login'
            } else {
        ...
        >
            ...
            <div className="relative w-full max-w-sm mx-4">
                ...
                <div className="relative rounded-3xl border border-white/10
                    bg-gradient-to-b from-white/[0.08] to-white/[0.03] backdrop-blur-2xl
                    ...
                    <div className="flex flex-col items-center gap-3 mb-1">
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-white/35 text-sm mt-0.5">Create your account</p>
                        </div>
                    </div>
